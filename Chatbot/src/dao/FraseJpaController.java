...
public class FraseJpaController implements Serializable {
    ...
    public void edit(Frase frase) throws NonexistentEntityException, Exception {
        EntityManager em = null;
        try {
            em = getEntityManager();
            em.getTransaction().begin();
            ...
            for (Respostas respostasCollectionOldRespostas : respostasCollectionOld) {
                if (!respostasCollectionNew.contains(respostasCollectionOldRespostas)) {
                    respostasCollectionOldRespostas.setIdFrase(null);
                    respostasCollectionOldRespostas = em.merge(respostasCollectionOldRespostas);
                }
            }
    ...
    public void destroy(Integer id) throws NonexistentEntityException {
        ...
        try {
            ...
            Collection<Respostas> respostasCollection = frase.getRespostasCollection();
            for (Respostas respostasCollectionRespostas : respostasCollection) {
                respostasCollectionRespostas.setIdFrase(null);
                respostasCollectionRespostas = em.merge(respostasCollectionRespostas);
            }
            em.remove(frase);
            em.getTransaction().commit();
